...
| --- | --- | --- |
| **LibreOffice Writer** | Procesador de texto libre, equivalente a Word. Ideal para el informe completo. | Gratis |
| **Microsoft Word** | Procesador de texto clásico. Si tu PC ya lo tiene, funciona perfecto. | De pago / institucional |
...
| Herramienta | Para qué sirve |
| --- | --- |
| **Canva** | Plantillas listas para organigramas, árbol del problema, árbol de objetivos y matriz FODA. Muy visual. |
| **draw.io / diagrams.net** | Editor libre de diagramas. Permite exportar a PNG/PDF. |
| **LibreOffice Draw** | Viene con LibreOffice. Útil para esquemas simples. |
...
| Herramienta | Para qué sirve |
| --- | --- |
| **LibreOffice Calc** | Hoja de cálculo libre. Ideal para plan de acción y matriz de seguimiento. |
| **Microsoft Excel** | Equivalente comercial. |
| **Google Sheets** | Hojas en la nube, útil para trabajar en equipo. |

## Cronograma (Gantt)

| Herramienta | Para qué sirve |
| --- | --- |
| **LibreOffice Calc** con formato condicional | El método más simple: filas para actividades, columnas para semanas. |
| **GanttProject** | Software libre dedicado a cronogramas Gantt. |
| **TeamGantt** | Alternativa online con plan gratuito limitado. |

## Infografías, afiches y materiales para los talleres

| Herramienta | Para qué sirve |
| --- | --- |
| **Canva** | Imbatible para afiches, infografías y materiales didácticos. |
| **Genially** | Permite crear infografías interactivas. |
| **Piktochart** | Plantillas de infografía bien diseñadas. |

## Presentaciones para la defensa

| Herramienta | Para qué sirve |
| --- | --- |
| **LibreOffice Impress** | Equivalente libre de PowerPoint. |
| **Microsoft PowerPoint** | Estándar tradicional. |
| **Canva Presentaciones** | Plantillas modernas, exporta a PDF o PPT. |

## Esquema oficial del PST I
